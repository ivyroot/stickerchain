...
export function createStickerSlappedEvent(
  placeId: BigInt,
  stickerId: BigInt,
  player: Address,
  slapId: BigInt,
  ...
  let stickerSlappedEvent = changetype<StickerSlapped>(newMockEvent())

  stickerSlappedEvent.parameters = new Array()

  stickerSlappedEvent.parameters.push(
    new ethereum.EventParam(
      "placeId",
      ethereum.Value.fromUnsignedBigInt(placeId)
    )
  )
  stickerSlappedEvent.parameters.push(
    new ethereum.EventParam(
  ...
  stickerSlappedEvent.parameters.push(
    new ethereum.EventParam("slapId", ethereum.Value.fromUnsignedBigInt(slapId))
  )
  stickerSlappedEvent.parameters.push(
    new ethereum.EventParam("size", ethereum.Value.fromUnsignedBigInt(size))
  )

  return stickerSlappedEvent
}
